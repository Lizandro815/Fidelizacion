...
<body>
    <div class="sidebar">
        ...
        <a href="tickets.php" class="<?= basename($_SERVER['PHP_SELF']) == 'tickets.php' ? 'active' : '' ?>">Tickets</a>
        <a href="almacenamiento.php" class="<?= basename($_SERVER['PHP_SELF']) == 'almacenamiento.php' ? 'active' : '' ?>">Almacenamiento</a>
